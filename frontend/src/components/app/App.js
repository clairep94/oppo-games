  ...
  return (
    <Routes>
      ...
      <Route
        path="/tictactoe"
        element={
          <TttInfoPage navigate={useNavigate()} gameTitle={"Tic Tac Toe"} />
        }
      />
      <Route
        path="/battleships"
        element={
          <BattleInfoPage navigate={useNavigate()} gameTitle={"Battleships"} />
        }
      />
      ...
      <Route
        path="/welcome"
        element={
          !isLoggedIn() ? <Landing navigate={navigate} /> : <Navigate to="/" />
        }
      />
      ...
      <Route
        ...
        element={
          isLoggedIn() ? (
            <ProtectedRoutes navigate={navigate} />
          ) : (
            <Navigate to="/welcome" />
          )
        }
