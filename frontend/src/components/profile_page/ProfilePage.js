...
const ProfilePage = (props) => {
  ...
  const { token, setToken, sessionUserID, sessionUser } =
  ...
  return (
    <>
      {/* background div */}
      <div className="bg-auto min-h-screen" style={profileBgImage}>
        {ownProfile ? (
          <>
            ...
            <div className="flex items-center justify-center">
              <img
                ...
                alt="Your Image"
                width="200px"
                className="max-w-full max-h-full my-11 border-[0.4rem] rounded-full"
              />
            </div>
            ...
            <h4 className="mb-9 text-white font-bold text-center">
